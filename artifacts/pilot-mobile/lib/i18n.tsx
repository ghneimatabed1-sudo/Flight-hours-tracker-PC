...
const EN: Dict = {
  ...
  lock_hint_forgot: "Forgot it? Ask your operations officer to unlink your device and re-pair it.",
  common_back: "Back",
...
const AR: Dict = {
  ...
  lock_hint_forgot: "نسيتها؟ اطلب من ضابط العمليات إلغاء ربط جهازك وإعادة ربطه.",
  common_back: "رجوع",
  settings_about: "حول",
  settings_about_text:
