...
const EN: Dict = {
  ...
  link_militaryNumber: "Username (military number, name or call sign)",
  link_code: "Verification Code",
  link_submit: "Link Account",
  link_error_generic: "Could not link your profile.",
  link_error_not_found: "No pilot found with that username. Ask your squadron Operations Officer to check what username is set for you on the squadron PC.",
...
const AR: Dict = {
  ...
  link_militaryNumber: "اسم المستخدم (الرقم العسكري أو الاسم أو الاسم الحركي)",
  link_code: "رمز التحقق",
  link_submit: "ربط الحساب",
  link_error_generic: "تعذر ربط حسابك.",
  link_error_not_found: "لا يوجد طيار بهذا اسم المستخدم. تواصل مع ضابط العمليات للتأكد من الاسم المسجَّل لك على جهاز السرب.",
